...
"""
chempots = pd.read_csv("../data/stable_windows_3+_4+_mix.csv")
chempots_transposed = chempots.transpose()
print(chempots_transposed)
chempots_transposed.to_csv("../data/stable_windows_3+_4+_mix_transposed.csv")
"""

chempots = pd.read_csv("../data/stable_windows_3+_4+_mix_transposed.csv")
print(chempots)
